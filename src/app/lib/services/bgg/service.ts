...
const parseCollectionXml = (xml?: string): BggCollectionItem[] | undefined => {
    ...
    return Array.from(rawItems.children)
        .map(item => {
            ...
            const wishlistPriority = status ? elementGetter(status, true, undefined, 'wishlistpriority') : undefined;
...
export const getCollectionItemFromObject = (object: BggRawObject) => {
    ...
    return {
        ...
        ...conditionalProps(object, 'comment'),
        ...conditionalTextField(object, 'comment'),
