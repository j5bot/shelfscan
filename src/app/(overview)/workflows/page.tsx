    ...
    return <>
        ...
        <div className="page-content w-screen pt-15 flex justify-center">
            <div className={`flex flex-col flex-wrap w-10/12 md:w-2/3
                ...
                <ul className="list-disc font-sharetech pl-5 underline">
                    <li><a href="#initial-collection-loading">Initial Collection
                        Loading</a></li>
                    <li><a href="#collection-maintenance">Collection Maintenance</a></li>
                    <li><a href="#collection-audit">Collection Audit</a></li>
                    <li><a href="#collection-quick-filtering">Collection Quick
                        Filtering</a></li>
                </ul>
                ...
                <h2 className="text-lg pt-2" id="initial-collection-loading">Initial Collection Loading</h2>
                ...
                <p>Simply go to <a href="/batch">https://www.shelfscan.io/batch</a>
                    (Batch Scan in the navigation) and begin scanning game UPCs using your camera.
                </p>
                ...
                <p>When you're done with a grouping of games, click the 'Add [X] Games to
                ...
                <p>The symbol on the ShelfScan extension will spin, indicating that the BGG update
                    is in progress. Once the symbol stops spinning,
                    the games will have been added to your collection.</p>

                <h2 className="text-lg pt-2" id="collection-maintenance">Collection Maintenance</h2>
                ...
                <ol className="list-decimal pl-5 pt-2">
                    ...
                    <li>Click the arrow next to the 'Set Info' button/dropdown (the
                        first one) and select 'Clear Statuses'</li>
                ...
                <h2 className="text-lg pt-2" id="collection-quick-filtering">Collection Quick
                    Filtering</h2>
