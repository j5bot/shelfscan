    ...
    return (<>
        ...
        <dialog ref={dialogRef} className="modal">
            <div className="modal-box min-w-86">
                <form method="dialog">
                    <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-4" aria-label="Close">✕</button>
                </form>
                {dialogContent}
            </div>
        </dialog>
        <div className="drawer drawer-end">
            ...
            <div className="drawer-content absolute top-4 right-5">
                <label htmlFor="nav-drawer" className="drawer-button cursor-pointer"><FaBars className="w-5.5 h-5.5" /></label>
            </div>
