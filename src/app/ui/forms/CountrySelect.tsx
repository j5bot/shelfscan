...
const countries = [
    ...
    { value: 'Other-Eastern Europe', label: 'Other-Eastern Europe' },
    { value: 'Other-Middle East', label: 'Other-Middle East' },
    { value: 'Other-South Pacific', label: 'Other-South Pacific' },
...
export const CountrySelect = ({ country, setValue }:
    ...
    <select name="country"
            className={`select select-sm pl-1.5 p-1`}
